...
public class RapportService implements Irapport {
	...
	public List<Rapport> getRapportOptionRapportCodeNull(List<String> organisation, String element, String periode) {
		List<Rapport> rapports = new ArrayList<Rapport>();
		rapports = RapportRepository.findByOrganisationUidInAndElementCodeAndPeriode(organisation, element, periode);
		return rapports;
	}
	...
	@Override
	public String saveRapport(List<Rapport> rapports) {
